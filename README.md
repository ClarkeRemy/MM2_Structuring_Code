...
- ## `.md` tutorial text files
  ...
  - | `structuring_code_05_Going_Wide.md`        
    ...
    - Fork/Join
    - making a main loop
  - | `structuring_code_06_Going_Wide_Macros.md`
    - generalizing fork/join
    - specializing at startup with macro expansion
  - | `structuring_code_07_Going_Wide_Larger_Programs.md`
  ...
  - | `structuring_code_08_Going_Wide_2_Programs.md`
  ...
  - | `structuring_code_09_In_Closing.md`
    - take stock of the subjects that were covered
    - ideas to consider
  - | `structuring_code_10_Rust_Extra.md`
...
- ## `mork_playground/`
  ...
  mentioned in `structuring_code_10_Rust_Extra.md`
