...
If one wants to jump right in, head to [`structuring_code_02_Basics.md`](https://github.com/ClarkeRemy/MM2_Structuring_Code/blob/main/structuring_code/structuring_code_02_Basics.md).
